             ...
             query.find("have") != string::npos)
    {
        ...
        if (inventory) {
            ...
            if (!foundPlant.empty()) {
                ...
                if (foundPlant == "carnivorous") inventoryKey = "CarnivorousPlant";
                else if (foundPlant == "tropical") inventoryKey = "TropicalPlant";
                else if (foundPlant == "temperate") inventoryKey = "TemperatePlant";
                else if (foundPlant == "succulent") inventoryKey = "SucculentPlant";
...
vector<string> Worker::getAvailablePlantTypes()
{
    ...
    Inventory* inventory = getInventory();  
    if (!inventory) return availableTypes;
